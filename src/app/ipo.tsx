                  ...
                  <tbody>
                    {upcomingIPOs.map((ipo) => (
                      <tr key={ipo.name} className="bg-white border-b hover:bg-gray-50">
                        <td className="px-2 py-1 md:px-6 md:py-3 font-medium">{ipo.name}</td>
                        <td className="px-2 py-1 md:px-6 md:py-3">₹{ipo.price}</td>
                        <td className="px-2 py-1 md:px-6 md:py-3">{ipo.lotSize}</td>
                        <td className="px-2 py-1 md:px-6 md:py-3">{ipo.issue}</td>
